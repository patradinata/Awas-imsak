...
const RamadhanCountdown = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[99999] bg-[#0d1811] border border-[#3e664e] p-6 rounded-lg shadow-lg max-w-sm animate-fade-in">
      <button onClick={handleClose} className="absolute top-2 left-2 text-gray-400 hover:text-white transition-colors w-6 h-6 flex items-center justify-center rounded-full hover:bg-[#1a2e22]">
        ×
      </button>

      <div className="text-center">
        <h2 className="text-xl font-bold text-white">Ramadhan 2025 / 1446 H</h2>
        <p className="text-sm mb-4 text-gray-400">1 Maret 2025</p>
